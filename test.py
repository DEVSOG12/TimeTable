...
class Class:
    ...
    def __init__(self, classname):
        self.name = classname
        self.timetable = {"Monday": {}, "Tuesday": {}, "Wednesday": {}, "Thursday": {}, "Friday": {}}
...
def randomize_labs():
    periods_to_select = [["Monday", (5, 6)], ["Monday", (7, 8)], ["Tuesday", (5, 6)], ["Tuesday", (7, 8)],
                         ["Wednesday", (5, 6)], ["Wednesday", (7, 8)], ["Thursday", (5, 6)],
                         ["Thursday", (7, 8)], ["Friday", (5, 6)], ["Friday", (7, 8)], ["Monday", (5, 6)],
                         ["Monday", (7, 8)], ["Tuesday", (5, 6)], ["Tuesday", (7, 8)],
                         ["Wednesday", (5, 6)], ["Wednesday", (7, 8)], ["Thursday", (5, 6)], ["Thursday", (7, 8)],
                         ["Friday", (5, 6)], ["Friday", (7, 8)]]
    chemtaken = []
    phytaken = []
    returnlist = ()
    for i in range(8):
...
def randomize_electivelabs(obj, elective):
    electives_to_select = [["Monday", (5, 6)], ["Monday", (7, 8)], ["Tuesday", (5, 6)], ["Tuesday", (7, 8)],
                           ["Wednesday", (5, 6)], ["Wednesday", (7, 8)], ["Thursday", (5, 6)],
                           ["Thursday", (7, 8)], ["Friday", (5, 6)], ["Friday", (7, 8)]]
    to_remove = []
...
def randomize_phy(obj, elective, option=False):
    ...
    phyperiodsday1 = list(range(1, 9))
    phyperiodsday2 = list(range(1, 9))
    ...
    return [(phyday1, phyday1period1), (phyday1, phyday1period2), (phyday2, phyday2period1), (phyday2, phyday2period2),
            (days[0], phyday3), (days[1], phyday4), (days[2], phyday5)]
...
def randomize_chem(obj, elective, option=False):
    while True:
        ...
        while True:
            ...
            chemperiodsday1 = list(range(1, 9))
            chemperiodsday2 = list(range(1, 9))
        ...
        chemperiodsday3 = list(range(1, 9))
        for a in table[days[0]]:
        ...
        try:
            ...
            br = False
        chemperiodsday4 = list(range(1, 9))
        for b in table[days[1]]:
        ...
        try:
            ...
            br = False
        chemperiodsday5 = list(range(1, 9))
        for c in table[days[2]]:
    ...
    return [(chemday1, chemday1period1), (chemday1, chemday1period2), (chemday2, chemday2period1),
            (chemday2, chemday2period2), (days[0], chemday3), (days[1], chemday4),
            (days[2], chemday5)]
...
def randomize_electives(obj, elective, occupied=False):
    ...
    possibilities = []
    for i in range(1, 9):
        if i not in table["Monday"]:
            possibilities.append(("Monday", i))
    for j in range(1, 9):
        if j not in table["Tuesday"]:
            possibilities.append(("Tuesday", j))
    for k in range(1, 9):
        if k not in table["Wednesday"]:
            possibilities.append(("Wednesday", k))
    for l in range(1, 9):
        if l not in table["Thursday"]:
            possibilities.append(("Thursday", l))
    for m in range(1, 9):
        if m not in table["Friday"]:
            possibilities.append(("Friday", m))
    if occupied:
        if elective == 'B':
            ...
            for removeitem in electives_occupied['Computer2']:
                if removeitem in possibilities:
                    possibilities.remove(removeitem)
        elif elective == 'F. Maths':
            for removeitem in electives_occupied['F. Maths']:
                if removeitem in possibilities:
                    possibilities.remove(removeitem)
    l = []
    ...
    if elective == 'B':
        ...
        electives_occupied['F. Maths'].append(first)
        electives_occupied['F. Maths'].append(second)
        electives_occupied['F. Maths'].append(third)
        electives_occupied['F. Maths'].append(fourth)
        electives_occupied['F. Maths'].append(fifth)
...
electivelabs_occupied = {'Bio Lab': [], 'Comp Lab': [], 'Phy Lab': []}
phy_occupied = {}
chem_occupied = {}
electives_occupied = {'Biology': [], 'Computer1': [], 'Computer2': [], 'F. Maths': []}
...
class_11SciE.labadd(randomize_electivelabs(class_11SciD, 'C'), 'Comp Lab')
...
class_12SciF.labadd(randomize_electivelabs(class_12SciD, 'C'), 'Comp Lab')
# class_12SciG.labadd(randomize_electivelabs(class_12SciG,'E'),'F. Maths Lab')
...
class_11SciD.electivesadd(randomize_electives(class_11SciD, 'B', True), 'Biology')
class_11SciE.electivesadd(randomize_electives(class_11SciD, 'C1'), 'Computer')
# class_11SciF.electivesadd(randomize_electives(class_11SciF,'C2'),'Computer')
class_11SciG.electivesadd(randomize_electives(class_11SciD, 'F. Maths'), 'F. Maths')
class_12SciD.electivesadd(randomize_electives(class_12SciD, 'B', True), 'Biology')
class_12SciE.electivesadd(randomize_electives(class_12SciD, 'B', True), 'Computer')
class_12SciF.electivesadd(randomize_electives(class_12SciD, 'B', True), 'Computer')
class_12SciG.electivesadd(randomize_electives(class_12SciD, 'B', True), 'F. Maths')
...
class_11SciD.electivesadd(assign_freeperiods(class_11SciD), 'Free Per.')
# Extra Cases
# class_11SciE.electivesadd(assign_freeperiods(class_11SciE),'Free Per.')
# class_11SciF.electivesadd(assign_freeperiods(class_11SciF),'Free Per.')
# class_11SciG.electivesadd(assign_freeperiods(class_11SciG),'Free Per.')
class_12SciD.electivesadd(assign_freeperiods(class_12SciD), 'Free Per.')
#  Extra Cases
# class_12SciE.electivesadd(assign_freeperiods(class_12SciE),'Free Per.')
# class_12SciF.electivesadd(assign_freeperiods(class_12SciF),'Free Per.')
# class_12SciG.electivesadd(assign_freeperiods(class_12SciG),'Free Per.')
